...
Parameter.create(id: 6, name: 'Default Cryptographic Keys size', description: 'Defines the cipher size within 256, 512, 1024, 2048 at key creation', code: 'SIZE', value: '256')
Parameter.create(id: 7, name: '256 bits', description: 'Key for AES256 crypting algorithm', code: 'AES256', value: '256', list_name: 'Key_Sizes')
Parameter.create(id: 8, name: '512 bits', description: 'Key for AES512 crypting algorithm', code: 'AES512', value: '512', list_name: 'Key_Sizes')
Parameter.create(id: 9, name: '1024 bits', description: 'Key for AES1024 crypting algorithm', code: 'AES1024', value: '1054', list_name: 'Key_Sizes')
#Parameter.create(id: 10, name: '2048 bits', description: 'Key for AES2048 crypting algorithm', code: 'AES2048', value: '2048', list_name: 'Key_Sizes')
#Parameter.create(id: 11, name: '4096 bits', description: 'Key for AES4096 crypting algorithm', code: 'AES4096', value: '4096', list_name: 'Key_Sizes')
end
