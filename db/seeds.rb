...
Parameter.create(id: 2, name: 'Keys administrator role', description: 'The DPO manages the keys organisation wide (aka Data Protection Officer)', code: '0', value: 'Administrator', list_name: 'Roles', created_by: 'RAKE', updated_by: 'RAKE')
Parameter.create(id: 3, name: 'Statistical Sector Manager', description: 'Statistical Sector Manager (aka Business Manager)', code: '1', value: 'StatAdmin', list_name: 'Roles', created_by: 'RAKE', updated_by: 'RAKE')
Parameter.create(id: 4, name: 'Statistics responsible', description: 'Owner and responsible for several statistics (aka Data Owner)', code: '2', value: 'KeyAdmin', list_name: 'Roles', created_by: 'RAKE', updated_by: 'RAKE')
Parameter.create(id: 5, name: 'Statistic data steward', description: 'Statistic data steward (aka Data Steward)', code: '3', value: 'StatWorker', list_name: 'Roles', created_by: 'RAKE', updated_by: 'RAKE')
