...
Parameter.create(id: 3, name: 'Statistical Sector Manager', description: 'Statistical Sector Manager (aka Business Manager)', code: '2', value: 'StatAdmin', list_name: 'Roles', created_by: 'RAKE', updated_by: 'RAKE')
Parameter.create(id: 4, name: 'Statistics responsible', description: 'Owner and responsible for several statistics (aka Data Owner)', code: '3', value: 'KeyAdmin', list_name: 'Roles', created_by: 'RAKE', updated_by: 'RAKE')
Parameter.create(id: 5, name: 'Statistic data steward', description: 'Statistic data steward (aka Data Steward)', code: '4', value: 'StatWorker', list_name: 'Roles', created_by: 'RAKE', updated_by: 'RAKE')
